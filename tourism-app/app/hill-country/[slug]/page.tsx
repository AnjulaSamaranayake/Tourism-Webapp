...
import { hillCountryPlaces } from "@/lib/data/hill-country"

export default function HillCountryDetailPage() {
    const params = useParams()
    const slug = params.slug as string
    const place = hillCountryPlaces[slug as keyof typeof hillCountryPlaces]

    if (!place) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center">
                <h1 className="text-2xl font-bold mb-4">Place not found</h1>
                <Link href="/hill-country-tours">
                    <Button>Back to Hill Country Tours</Button>
                </Link>
            </div>
        )
    }
            ...
            <main className="min-h-screen bg-background">
                ...
                <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                        <Link href="/hill-country-tours" className="inline-flex items-center text-sm font-medium mb-6 hover:text-primary transition-colors">
                            <ChevronLeft className="h-4 w-4 mr-1" />
                            Back to Hill Country Tours
                        </Link>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                            <div className="space-y-8">
                                ...
                                <div className="p-8 bg-muted rounded-2xl border border-primary/10">
                                    <h3 className="text-2xl font-bold mb-4 text-foreground">Why It's Captivating</h3>
                            ...
                            <div className="bg-muted p-8 rounded-3xl space-y-8 sticky top-24">
                                <h3 className="text-2xl font-bold border-b border-primary/20 pb-4">Highland Highlights</h3>
                ...
                <section className="py-20 bg-muted">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold mb-12 text-center">Cloud-Kissed Views</h2>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <Card className="p-8 border-none shadow-lg bg-muted/50 hover:bg-muted transition-colors">
                                ...
                                <h4 className="text-lg font-bold mb-2">Wildlife</h4>
                            ...
                            <Card className="p-8 border-none shadow-lg bg-muted/50 hover:bg-muted transition-colors">
                                ...
                                <h4 className="text-lg font-bold mb-2">Stay Length</h4>
                ...
                <section className="py-20 bg-muted/30">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold mb-12 flex items-center justify-center">
                            ...
                            Highland Travel Essentials
                        </h2>
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Mountain Packing</h4>
                                <p className="text-muted-foreground leading-relaxed">{place.travelTips.packing}</p>
                            </div>
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Entry & Access</h4>
                                <p className="text-muted-foreground leading-relaxed">{place.travelTips.entry}</p>
                            </div>
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Responsible Tourism</h4>
                ...
                <section className="py-24 bg-primary text-primary-foreground">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-4xl sm:text-5xl font-bold mb-8">Ready to explore {place.title}?</h2>
