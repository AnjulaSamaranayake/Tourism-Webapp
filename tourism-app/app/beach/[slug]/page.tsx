...
import { beachPlaces } from "@/lib/data/beaches"

export default function BeachDetailPage() {
    const params = useParams()
    const slug = params.slug as string
    const place = beachPlaces[slug as keyof typeof beachPlaces]

    if (!place) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center">
                <h1 className="text-2xl font-bold mb-4">Place not found</h1>
                <Link href="/beach-tours">
                    <Button>Back to Beach Tours</Button>
                </Link>
            </div>
        )
    }
            ...
            <main className="min-h-screen bg-background">
                ...
                <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center text-white px-4 max-w-4xl">
                        <Link href="/beach-tours" className="inline-flex items-center text-sm font-medium mb-6 hover:text-primary transition-colors">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                            <div className="space-y-8">
                                ...
                                <div className="p-8 bg-muted rounded-2xl border border-primary/10">
                                    <h3 className="text-2xl font-bold mb-4 text-foreground">Why It's Special</h3>
                            ...
                            <div className="bg-muted p-8 rounded-3xl space-y-8 sticky top-24">
                                <h3 className="text-2xl font-bold border-b border-primary/20 pb-4">Coastal Highlights</h3>
                ...
                <section className="py-20 bg-muted">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold mb-12 text-center">Sun, Sand & Soul</h2>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <Card className="p-8 border-none shadow-lg bg-muted/50 hover:bg-muted transition-colors">
                                ...
                                <h4 className="text-lg font-bold mb-2">Best Time to Visit</h4>
                                <p className="text-muted-foreground">{place.details.bestTime}</p>
                            </Card>
                            <Card className="p-8 border-none shadow-lg bg-muted/50 hover:bg-muted transition-colors">
                                <Waves className="h-10 w-10 text-primary mb-4" />
                                <h4 className="text-lg font-bold mb-2">Ocean Life</h4>
                            ...
                            <Card className="p-8 border-none shadow-lg bg-muted/50 hover:bg-muted transition-colors">
                                ...
                                <h4 className="text-lg font-bold mb-2">Recommended Stay</h4>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Essential Packing</h4>
                                <p className="text-muted-foreground leading-relaxed">{place.travelTips.packing}</p>
                            </div>
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Logistics & Planning</h4>
                                <p className="text-muted-foreground leading-relaxed">{place.travelTips.entry}</p>
                            </div>
                            <div className="space-y-4">
                                <h4 className="text-xl font-bold text-primary italic">Sustainable Tourism</h4>
                ...
                <section className="py-24 bg-primary text-primary-foreground">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-4xl sm:text-5xl font-bold mb-8">Dreaming of {place.title}?</h2>
                        <p className="text-xl mb-12 max-w-2xl mx-auto opacity-90">
                            Let us help you find the perfect coastal retreat. From boutique surf lodges to luxury oceanfront villas, we'll design a journey that fits your rhythm.
                        </p>
                        <Link href="/contact">
