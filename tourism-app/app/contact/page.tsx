...
const GradientDivider = () => (
  <div className="h-px bg-gradient-to-r from-transparent via-border to-transparent my-6 max-w-md mx-auto" />
);
              ...
              {contactChannels.map((channel, index) => {
                ...
                return (
                  <a
                    key={index}
                    href={channel.link}
                    className="p-8 border border-border rounded-lg shadow-sm hover:shadow-xl hover:border-primary/50 transition-all bg-card group relative overflow-hidden"
                  >
                    {/* Background Icon */}
        ...
        <section className="relative py-16 md:py-24 from-primary/5 via-secondary/5 to-primary/5 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              {/* Location */}
              <div className="relative p-8 bg-background border border-border rounded-lg shadow-sm group overflow-hidden hover:shadow-xl transition-shadow">
